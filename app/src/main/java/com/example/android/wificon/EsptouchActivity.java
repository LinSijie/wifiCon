...
import com.example.android.wificon.utilities.EspUtils;
...
public class EsptouchActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private class EsptouchAsyncTask4 extends AsyncTask<byte[], Void, List<IEsptouchResult>> {
        ...
        protected void onPostExecute(List<IEsptouchResult> result) {
                ...
                if (firstResult.isSuc()) {
                    ...
                    for (IEsptouchResult resultInList : result) {
                        sb.append("Esptouch success, bssid = ")
                                ...
                                .append("\n");
                        hostIP = resultInList.getInetAddress().getHostAddress();
                        count++;
            ...
            activity.mTask = null;
            Log.i(TAG, "onPostExecute:hostIP = " + hostIP);
            if(ifSuccess){
                Intent intent = new Intent(EsptouchActivity.this, ColorPicker.class);
                intent.putExtra("hostIP", hostIP);
                Log.i(TAG, "onPostExecute: before startActivity");
